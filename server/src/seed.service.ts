...
export class SeedService implements OnModuleInit {
    ...
    private async seedAll() {
        ...
        // Work Orders (tenant-mx) — with service location coordinates
