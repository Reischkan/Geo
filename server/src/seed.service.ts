...
export class SeedService implements OnModuleInit {
    ...
    private async seedAll() {
        ...
        await this.orderRepo.save([
            ...
            { id: 'OT-2402', title: 'Reparación Fuga de Agua', client: 'Torre Corporativa Alfa', clientAddress: 'Blvd. Miguel de Cervantes 150', technicianId: 'T002', status: 'en-progreso', priority: 'alta', scheduledDate: '2026-02-23', estimatedDuration: '2h', projectId: undefined, description: 'Fuga detectada en el piso 12, baño de ejecutivos' },
            { id: 'OT-2403', title: 'Mantenimiento A/C Preventivo', client: 'Hospital Santa Fe', clientAddress: 'Av. Vasco de Quiroga 3000', technicianId: 'T003', status: 'pendiente', priority: 'media', scheduledDate: '2026-02-23', estimatedDuration: '3h', projectId: undefined, description: 'Mantenimiento preventivo de 6 unidades HVAC' },
            ...
            { id: 'OT-2406', title: 'Revisión Tablero Eléctrico', client: 'Fábrica Omega', clientAddress: 'Parque Industrial Naucalpan', technicianId: 'T001', status: 'pendiente', priority: 'alta', scheduledDate: '2026-02-24', estimatedDuration: '2h', projectId: undefined, description: 'Diagnóstico y corrección de tablero principal de distribución' },
            { id: 'OT-2407', title: 'Instalación Calentador Solar', client: 'Residencial Monte Alto', clientAddress: 'Cerrada de los Pinos 45', technicianId: 'T002', status: 'pendiente', priority: 'media', scheduledDate: '2026-02-24', estimatedDuration: '3h', projectId: undefined, description: 'Instalación de calentador solar 150L' },
            { id: 'OT-2408', title: 'Servicio A/C Emergencia', client: 'Restaurant La Hacienda', clientAddress: 'Av. Patriotismo 229', technicianId: 'T003', status: 'cancelada', priority: 'alta', scheduledDate: '2026-02-21', estimatedDuration: '2h', projectId: undefined, description: 'Cliente canceló — rescheduled para la siguiente semana' },
            ...
            { id: 'OT-2410', title: 'Instalación Cámaras CCTV', client: 'Farmacia Biofarma', clientAddress: 'Av. Coyoacán 1538', technicianId: 'T005', status: 'completada', priority: 'baja', scheduledDate: '2026-02-20', estimatedDuration: '4h', projectId: undefined, description: 'Instalación de 8 cámaras IP + NVR' },
        ]);
        ...
        const calEvents: Omit<CalendarEvent, 'id'>[] = [];
        ...
        for (const [day, events] of Object.entries(raw)) {
            for (const ev of events) {
                calEvents.push({ day: parseInt(day), month: 2, year: 2026, title: ev.title, tech: ev.tech, color: ev.color });
            }
        }
        ...
        await this.clientRepo.save([
            { id: 'C001', name: 'Residencial Las Lomas', contactName: 'Ing. Roberto Garza', phone: '+52 55 1111 2222', email: 'admin@laslomas.mx', address: 'Av. Reforma 234, Col. Polanco', lat: 19.4326, lng: -99.1332, notes: 'Acceso by badge — guardia en caseta', active: true },
            { id: 'C002', name: 'Edificio Sigma', contactName: 'Lic. Patricia Vega', phone: '+52 55 3333 4444', email: 'pvega@sigma.com', address: 'Insurgentes Sur 1602', lat: 19.3950, lng: -99.1700, notes: 'Estacionamiento subterráneo P3', active: true },
            { id: 'C003', name: 'Centro Comercial Delta', contactName: 'Arq. Marco Torres', phone: '+52 55 5555 6666', email: 'mtorres@delta.mx', address: 'Av. Universidad 1000', lat: 19.3500, lng: -99.1800, notes: 'Coordinar con administración para acceso locales', active: true },
            { id: 'C004', name: 'Edificio Gamma', contactName: 'Sr. Luis Herrera', phone: '+52 55 7777 8888', email: 'lherrera@gamma.mx', address: 'Calle Durango 247, Roma Norte', lat: 19.4200, lng: -99.1600, notes: 'Azotea tiene doble llave', active: true },
            { id: 'C005', name: 'Fábrica Omega', contactName: 'Ing. Sandra Ruiz', phone: '+52 55 9999 0000', email: 'sruiz@omega.ind.mx', address: 'Parque Industrial Naucalpan', lat: 19.4800, lng: -99.2300, notes: 'Requiere casco y chaleco', active: true },
            { id: 'C006', name: 'Hospital Santa Fe', contactName: 'Dr. Alejandro Fuentes', phone: '+52 55 1234 0000', email: 'mantenimiento@hsantafe.mx', address: 'Av. Vasco de Quiroga 3000', lat: 19.3660, lng: -99.2700, notes: 'Solo acceso por puerta de servicio', active: true },
        ]);
    }
}
